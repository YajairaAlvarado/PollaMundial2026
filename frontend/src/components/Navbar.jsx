...
import { Menu, X, Trophy, Calendar, User, LogOut, LayoutDashboard, Network, ShieldCheck, BookOpen, Gift, Brain } from 'lucide-react';
...
export default function Navbar({ unread = 0, onBellOpen }) {
  ...
  const navLinks = [
    ...
    { to: '/knowledge',   label: 'Quién sabe 🧠', icon: <Brain size={14} /> },
